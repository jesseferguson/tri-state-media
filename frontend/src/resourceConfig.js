...
const dieProcurementFields = [
  {
    ...
    step: "0.01",
    tab: "Procurement",
    section: "Price + Reorder",
    sectionHint: "Use these fields to track supplier quotes and reorder cost history.",
  },
  {
    name: "last_quote_price",
    label: "Last Quote Price",
    type: "number",
    step: "0.01",
    tab: "Procurement",
  },
  ...
  },
  {
    ...
    type: "textarea",
    placeholder: "Supplier quote notes, reorder details, lead time, or closest supplier notes",
    tab: "Procurement",
  },
];
...
export const resources = [
  ...
  {
    key: "flex-die-requests",
    endpoint: "flex-die-requests",
    label: "Process Flex Die Requests",
    singular: "Flex Die Request Permission",
    group: "tooling",
    icon: PackagePlus,
    permissionOnly: true,
    disableCreate: true,
    tagline: "Allows a role to mark requested flex dies ordered, received, or closed without ordering.",
    columns: [],
    fields: [],
  },
  {
...

  {
    key: "skids",
    label: "Skids",
    singular: "Skid Tracking",
    group: "production-material",
    icon: PackageOpen,
    accent: "#2563eb",
    staticView: true,
    viewMode: "materialStorageSkids",
    disableCreate: true,
    tagline: "Scan rolls onto skids, track current contents, and preserve every movement.",
    columns: [],
    fields: [],
  },
...

  {
    ...
    fields: [
      ...
      {
        name: "has_print",
        label: "This Job Has Print",
        type: "checkbox",
        tab: "Print",
        section: "Print Method",
        sectionHint: "Use static plates for physical plate jobs, digital static for printed work without plates, and dynamic for variable/barcode work.",
      },
      {
        name: "print_method",
        label: "Print Method",
        type: "select",
        choices: choiceLists.printMethod,
        defaultValue: "none",
        tab: "Print",
        section: "Print Method",
        showWhen: { has_print: true },
        clearWhenHidden: "none",
      },
      {
        name: "art_file_created",
        label: "Art File Created",
        type: "checkbox",
        tab: "Print",
        section: "Art File",
        showWhen: { has_print: true },
        helpText: "Art can mark this once the static or base dynamic file is ready.",
      },
      {
        ...
        tab: "Print",
        section: "Art File",
        showWhen: { art_file_created: true },
        clearWhenHidden: "",
      },
      {
        name: "print_plates",
        ...
        lookupFetchAll: true,
        tab: "Print",
        section: "Static Plate Setup",
        showWhen: { print_method: "static" },
        clearWhenHidden: [],
        helpText: "Select every plate this job uses. A job can use multiple plates or share plates with another job.",
      },
      {
        name: "print_notes",
        label: "Print Notes",
        type: "textarea",
        tab: "Print",
        section: "Operator Print Notes",
        showWhen: { has_print: true },
        clearWhenHidden: "",
        placeholder: "Plate handoff, digital file notes, customer color notes, or barcode setup details...",
      },
      {
        name: "box",
        label: "Box Link",
...

  {
    ...
    fields: [
      ...
      { name: "held_at", label: "Held At", type: "date", hidden: true },
      {
        ...
        label: "Dynamic File Created For This Order",
        type: "checkbox",
        defaultValue: false,
        section: "Dynamic File",
        helpText: "For dynamic/barcode jobs, check this only after the order-specific file is created.",
      },
      {
        ...
        type: "text",
        section: "Dynamic File",
        showWhen: { dynamic_file_created: true },
        clearWhenHidden: "",
      },
      {
...

  {
    ...
    fields: [
      ...
      { name: "received_date", label: "Received", type: "date" },
      {
        ...
        searchable: true,
        searchFields: ["name", "code", "location_type", "inventory_scope", "parent_name", "supplier_name"],
      },
      { name: "is_active", label: "Active", type: "checkbox", defaultValue: true },
      { name: "notes", label: "Notes", type: "textarea" },
    ],
...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Liner Supplier",
        type: "searchRelation",
        relation: "material-supplier-options",
        lookupFilters: { material_type: "liner" },
        searchable: true,
        searchFields: ["material_name", "material_family", "supplier_name", "option_name", "supplier_item_number", "thickness_mil", "width_inches"],
      },
      {
        name: "face",
        label: "Face",
      ...
      },
      {
        ...
        label: "Adhesive Supplier",
        type: "searchRelation",
        relation: "material-supplier-options",
        lookupFilters: { material_type: "adhesive" },
        searchable: true,
        searchFields: ["material_name", "material_family", "supplier_name", "option_name", "supplier_item_number"],
      },
      {
        name: "silicone",
        label: "Silicone",
      ...
      },
      {
        ...
        lookupFilters: { inventory_scope: "raw_material,shared" },
        searchable: true,
        searchFields: ["name", "code", "location_type", "inventory_scope", "parent_name"],
      },
...

  {
    ...
    fields: [
      ...
      { name: "run_date", label: "Run Date", type: "date" },
      {
        ...
        type: "searchRelation",
        relation: "locations",
        lookupFilters: { inventory_scope: "finished_product,shared" },
        searchable: true,
        searchFields: ["name", "code", "location_type", "inventory_scope", "parent_name"],
      },
      { name: "notes", label: "Notes", type: "textarea" },
...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "Legacy Dieline Link",
        type: "url",
        tab: "Jacket",
        placeholder: "https://...",
        helpText: "Optional old-system PDF/image link. Uploaded files take priority.",
      },
      {
        name: "external_dieline_source",
        label: "Legacy Link Source",
        type: "text",
        tab: "Jacket",
        placeholder: "Glide Tooling",
      },
      ...
      { ...linerDataTypeField, tab: "Cut" },
      supplierField("tooling", { label: "Current Supplier", section: "Storage", tab: "Storage" }),
      {
      ...
      },
      {
        ...
        label: "Known Compatible Presses",
        type: "multiRelation",
        relation: "presses",
        tab: "Storage",
        helpText: "Useful for legacy/imported compatibility. Exact setups still live under recipe tools.",
      },
      ...dieProcurementFields,
      {
        name: "notes",
        label: "Notes",
        type: "textarea",
...

  {
    ...
    fields: [
      ...
      },
      {
        ...
        tab: "Dimensions",
        section: "Label Size",
        sectionHint: "Solid/semi-rotary die dimensions.",
      },
      {
        name: "label_length_inches",
        label: "Label Length",
