...
export const resources = [
...

  {
    ...
    fields: [
      ...
      { name: "requested_quantity", label: "Requested Qty", type: "number", step: "0.001", defaultValue: 0 },
...

  {
    ...
    accent: "#60a5fa",
    disableCreate: true,
    defaultOrdering: "scheduled_date,priority,job_ticket__ticket_number",
    tagline: "Actively scheduled jobs with customer PO, ship/stock quantities, priority, press, material roll, and operator notes.",
    columns: [
      "order_date",
      "scheduled_date",
      "due_date",
      ...
      "customer_name",
      "job_name",
      "job_material_spec_code",
      "job_material_spec_name",
      "customer_po",
      "status",
      "priority",
      "quantity_to_ship",
    ...
    fields: [
      ...
      { name: "status", label: "Status", type: "select", choices: choiceLists.jobTicketStatus, defaultValue: "unscheduled" },
      ...
      { name: "due_date", label: "Due Date", type: "date" },
      {
        ...
        maxResults: 250,
        lookupFilters: { material_type: "coated_stock" },
        searchFields: ["material_name", "material_code", "material_family", "lot_number", "width_inches", "location_name"],
      },
