...
import RecordForm from "./shared/components/forms/RecordForm";
import ResourceTable from "./shared/components/tables/ResourceTable";
import FlexDieDetailPanel from "./features/tooling/components/FlexDieDetailPanel";
import FlexDieTable from "./features/tooling/components/FlexDieTable";
import FlexDieWorkspacePanel from "./features/tooling/components/FlexDieWorkspacePanel";
import FinishedInventoryView, { FinishedInventoryWindow } from "./features/inventory/components/FinishedInventoryView";
import FinishedMaterialWindow from "./features/materials/components/FinishedMaterialWindow";
import FootageReportsView from "./features/production/components/FootageReportsView";
import CustomerWorkspace from "./features/customers/components/CustomerWorkspace";
import CoaterOperatorView from "./features/production/components/CoaterOperatorView";
import DataImportTool from "./features/imports/components/DataImportTool";
import DeleteMaterialRollDialog from "./features/materials/components/DeleteMaterialRollDialog";
import GroupedLocationView from "./features/materials/components/GroupedLocationView";
import GroupedUsageView from "./features/materials/components/GroupedUsageView";
import JobTicketGallery from "./features/production/components/JobTicketGallery";
import JobTicketPanel from "./features/production/components/JobTicketPanel";
import LabelLayoutsView from "./features/tooling/components/LabelLayoutsView";
import LiveFootageView from "./features/production/components/LiveFootageView";
import MaterialInventoryView from "./features/materials/components/MaterialInventoryView";
import MaterialHandlingView, { activeJobKey } from "./features/materials/components/MaterialHandlingView";
import MaterialStorageView from "./features/materials/components/MaterialStorageView";
import MaterialTypeTable from "./features/materials/components/MaterialTypeTable";
import MaterialTypeWindow from "./features/materials/components/MaterialTypeWindow";
import MaterialTypeManager from "./features/materials/components/MaterialTypeManager";
import MaterialUsageWindow from "./features/materials/components/MaterialUsageWindow";
import MessagesCenter from "./features/messages/components/MessagesCenter";
import PackagingInventoryView from "./features/inventory/components/PackagingInventoryView";
import PressSpeedSidebarWidget from "./features/production/components/PressSpeedSidebarWidget";
import PressOperatorDashboard from "./features/production/components/PressOperatorDashboard";
import QuotePricingTool from "./features/quotes/components/QuotePricingTool";
import RecipeOptionsView from "./features/tooling/components/RecipeOptionsView";
import RecipeToolStackView from "./features/tooling/components/RecipeToolStackView";
import RollScanStation from "./features/materials/components/RollScanStation";
import RollWorkflowWindow from "./features/materials/components/RollWorkflowWindow";
import ProductionScheduleView from "./features/production/components/ProductionScheduleView";
import PressTable from "./features/production/components/PressTable";
import SupplierTable from "./features/suppliers/components/SupplierTable";
import ToolingItemDetailPanel from "./features/tooling/components/ToolingItemDetailPanel";
import {
  clearSession,
