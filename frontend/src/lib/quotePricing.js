...
export const wasteRecommendationRules = [
  { minFootage: 40000, wastePercent: 5, label: "40,000+ ft" },
  { minFootage: 10000.000001, wastePercent: 8, label: "10,001-39,999 ft" },
  { minFootage: 5000.000001, wastePercent: 15, label: "5,001-10,000 ft" },
  { minFootage: 2500.000001, wastePercent: 50, label: "2,501-5,000 ft" },
  { minFootage: 0, wastePercent: 75, label: "0-2,500 ft" },
];

export const colorWasteRecommendationRules = [
  { minFootage: 40000, wastePercentPerColor: 0, label: "40,000+ ft" },
  { minFootage: 10000.000001, wastePercentPerColor: 0, label: "10,001-39,999 ft" },
  { minFootage: 5000.000001, wastePercentPerColor: 0, label: "5,001-10,000 ft" },
  { minFootage: 2500.000001, wastePercentPerColor: 0, label: "2,501-5,000 ft" },
  { minFootage: 0, wastePercentPerColor: 0, label: "0-2,500 ft" },
];
